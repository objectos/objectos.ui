...
final class YResources {

  static final String CARBON_HTML = """
<!doctype html><html lang="en"><head><meta charset="utf-8"><title>Webpack App</title><meta name="viewport" content="width=device-width,initial-scale=1"><style>@font-face {
  ...
  body #storybook-root {
    width: 100%;
  }</style><link href="main.40ca93695f97b5ae8311.css" rel="stylesheet"><style>#storybook-root[hidden],
      ...
      import './runtime~main.3cf7041d.iframe.bundle.js';

      import './4350.d9c2f206.iframe.bundle.js';

      import './main.64a521e2.iframe.bundle.js';</script></body></html>
  """;
