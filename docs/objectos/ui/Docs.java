...
///
/// Bootstraps the Objectos UI Docs dev mode.
///
public final class Docs extends App.Bootstrap {

  public static final int DEVELOPMENT_HTTP_PORT = 8007;
  ...
  protected final void bootstrap() {
    ...
    try {
      ...
      httpServer = Http.Server.create(opts -> {
        ...
        opts.port(DEVELOPMENT_HTTP_PORT);
      });
  ...
  private record Reloader(App.Injector injector) implements App.Reloader.HandlerFactory {
    ...
    public final Http.Handler reload(ClassLoader loader) throws Exception {
      ...
      bootClass = loader.loadClass("objectos.ui.DocsModule");
